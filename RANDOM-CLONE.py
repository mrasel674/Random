...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★]NIROB\033[1;39m         ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★]    NIROB    KHAN\033[1;39m         ┃
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\033[1;34m: [★]FREE\033[1;39m                 ┃
 \033[1;39m    ┗━━━━━━━━━━━━━━━━━━━\033[1;31mNIROB\033[1;39m━━━━━━━━━━━━━━━━━━━━┛"""
loop = 0
oks = []
cps = []
...
try:
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Je Kno Proyojone jogajog korte paren...')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m NOTE : NOTUN SIKHCHI V...')
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m TOOLS USE KORE OBOSSY REVIEW DIBEN...')
    time.sleep(3)
    v = 5.2
    update = ('5.2')
    update = ('5.2')
    if str(v) in update:
        os.system('xdg-open https://www.facebook.com/groups/rasel674/')
    else:pass
...
def new(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="112.0.5620.223", "Google Chrome";v="112.0.5620.223"',
            'sec-ch-ua-mobile': '?0',
